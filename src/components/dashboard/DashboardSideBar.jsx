...
import { LayoutSideContentLeft, Bell, Briefcase, Envelope, Gear, House, Magnifier, Person, Bookmark, FileText, CreditCard, LayoutSideContent } from "@gravity-ui/icons";
...
export default async function DashboardSideBar() {
    ...
    return (
        <>
            <aside className="hidden lg:block shrink-0 w-64 p-4 border-r border-default ">
                {navContent}
            </aside>
